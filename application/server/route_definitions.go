...
func getRouteDefinitions(controllers *controllers.AllController) *[]common.RouteDefinition {
	return &[]common.RouteDefinition{
		...
		},
		{
			...
			Children: []common.RouteDefinition{
				{
					Path:          "/addResponseProfile",
					Method:        http.MethodPost,
					Description:   "Add Profile",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.AddResponseProfile,
				},
				{
					Path:          "/getAllResponseProfiles",
					Method:        http.MethodGet,
					Description:   "Get All Profiles",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.GetAllResponseProfiles,
				},
				{
					Path:          "/addInternalTag",
					Method:        http.MethodPost,
					Description:   "Add Internal Tag",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.AddInternalTag,
				},
				{
					Path:          "/getAllInternalTags",
					Method:        http.MethodGet,
					Description:   "Get All Internal Tags",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.GetAllInternalTags,
				},
				{
					Path:          "/addInternalTagGroup",
					Method:        http.MethodPost,
					Description:   "Add Internal Tag Group",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.AddInternalTagGroup,
				},
				{
					Path:          "/getAllInternalTagGroups",
					Method:        http.MethodGet,
					Description:   "Get All Internal Tag Groups",
					Authenticated: true,
					Authorized:    true,
					HandlerFunc:   controllers.ConfigurationController.GetAllInternalTagGroups,
				},
			},
		},
	}
